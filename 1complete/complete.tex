...
\begin{exercises}{}
	\emph{Key concepts:\quad Algebraic Numbers,\quad Rational Roots Theorem/Testing for Irrationality}%\smallbreak
...
\begin{exercises}{}{}
	\emph{Key concepts:\quad Suprema,\quad Completeness (distinguishes $\R$),\quad Contrapositive criterion,}%\vspace{-2pt}
	\begin{quote}
